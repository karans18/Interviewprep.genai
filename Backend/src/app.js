...
function getAllowedOrigins() {
  const defaultOrigins = [
    ...
    // ✅ YOUR FRONTEND (CRITICAL FIX)
    "https://interviewprep-genai.vercel.app",

    // ✅ OPTIONAL: preview deployments (Vercel generates random URLs)
    "https://interviewprep-genai-hrewtc1zf-karans18s-projects.vercel.app",
...
app.use("/api", (req, res, next) => {
  ...
  console.error(
    `[DB] Rejecting ${req.method} ${req.originalUrl} because MongoDB is unavailable.`,
  );
